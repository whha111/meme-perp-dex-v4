    ...
    <main className="min-h-screen bg-okx-bg-primary text-okx-text-primary">
      ...
      <section className="max-w-[1200px] mx-auto px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {([
            { icon: "🚀", title: t("features.fairLaunch.title"), desc: t("features.fairLaunch.desc") },
            { icon: "📈", title: t("features.perpetual.title"), desc: t("features.perpetual.desc") },
            { icon: "🔒", title: t("features.security.title"), desc: t("features.security.desc") },
            { icon: "💰", title: t("features.referral.title"), desc: t("features.referral.desc") },
            { icon: "⚡", title: t("features.matching.title"), desc: t("features.matching.desc") },
            { icon: "🎯", title: t("features.competition.title"), desc: t("features.competition.desc") },
          ]).map((feature, idx) => (
