                    ...
                    <table className="w-full text-xs min-w-[1000px]">
                      <thead>
                        <tr className="text-okx-text-tertiary border-b border-okx-border-primary">
                          ...
                          <th className="text-right py-2 px-1">{t("roe")}%</th>
                          <th className="text-center py-2 px-1">{t("tpSl")}</th>
